...
public interface HL7Service extends OpenmrsService {
	 ...
	 * {@link org.openmrs.api.impl.PatientServiceImpl#savePatient(Patient) savePatient()} call made in PatientServiceImpl class
	 * 
	...
	/**
	 * Save the given <code>hl7OutQueue</code> to the database for each 
	 * {@link org.openmrs.api.impl.EncounterServiceImpl#saveEncounter(Encounter) saveEncounter()} call made in EncounterServiceImpl class
	 * 
	 * @param patient the Patient object
	 * @param hl7OutQueue the item to be saved into the database
	 * @return the saved HL7OutQueue object
	...
	@Transactional(readOnly = true)
	//@Authorized(HL7Constants.PRIV_VIEW_HL7_IN_QUEUE)
	public List<HL7OutQueue> getHL7OutQueueBatch(int start, int length, int messageState, String query) throws APIException;
	...
	/**
	 * the total count of all HL7OutQueue objects in the database
	 * 
	 * @param messageState HL7OutQueue status
	 * @param query search string
	 * @return the count of matching HL7OutQueue items
	 * @throws APIException
	 * @since 1.7
	 */
	@Transactional(readOnly = true)
	//@Authorized(HL7Constants.PRIV_VIEW_HL7_IN_QUEUE)
	public Integer countHL7OutQueue(int messageState, String query) throws APIException;
