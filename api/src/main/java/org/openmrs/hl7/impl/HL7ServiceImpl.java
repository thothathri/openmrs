...
public class HL7ServiceImpl extends BaseOpenmrsService implements HL7Service {
	...
	/**
	 * @see org.openmrs.hl7.HL7Service#getHL7OutQueueBatch(int, int, java.lang.String)
	 */
	@Override
	public List<HL7OutQueue> getHL7OutQueueBatch(int start, int length, int messageState, String query) throws APIException {
		return dao.getHL7Batch(HL7OutQueue.class, start, length, messageState, query);
	}
	...
	/**
	 * @see org.openmrs.hl7.HL7Service#countHL7OutQueue(int, java.lang.String)
	 */
	@Override
	public Integer countHL7OutQueue(int messageState, String query) throws APIException {
		return dao.countHL7s(HL7OutQueue.class, messageState, query);
	}
...
//	public HL7OutQueue saveEncounterHL7OutQueue(Patient patient, HL7OutQueue hl7outqueue) throws APIException {
		...
		encodedMessage = ORUEncoder.HL7EncodeOruR01Msg(encounter.getPatient().getPatientId(), a,b);
			...
			log.error("HL7 Exception while saving encounter for patient "+encounter.getPatient().getPatientId() ,e);
		}
		hl7outqueue.setHL7Data(encodedMessage);
		hl7outqueue.setErrorMessage("");
		if (hl7outqueue.getMessageState() == null)
