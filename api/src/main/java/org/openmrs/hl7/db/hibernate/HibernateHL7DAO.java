...
public class HibernateHL7DAO implements HL7DAO {
	...
	/**
	 * @see org.openmrs.hl7.db.HL7DAO#saveHL7OutQueue(org.openmrs.hl7.HL7OutQueue)
	 */
	public HL7OutQueue saveHL7OutQueue(HL7OutQueue hl7OutQueue) throws DAOException {
		sessionFactory.getCurrentSession().saveOrUpdate(hl7OutQueue);
		return hl7OutQueue;
	}
	
	/**
	 * @see org.openmrs.hl7.db.HL7DAO#getHL7OutQueue(java.lang.Integer)
	 */
	public HL7OutQueue getHL7OutQueue(Integer hl7OutQueueId) throws DAOException {
		return (HL7OutQueue) sessionFactory.getCurrentSession().get(HL7OutQueue.class, hl7OutQueueId);
	}
	...
	public HL7OutQueueDestination saveHL7OutQueueDestination(HL7OutQueueDestination hl7OutQueueDestination) throws DAOException {
		...
		sessionFactory.getCurrentSession().saveOrUpdate(hl7OutQueueDestination);
		System.out.println("********* Done SAVEHL7QueQDestn in HibernateHL7DAO**************" +hl7OutQueueDestination.getCreatedBy());
